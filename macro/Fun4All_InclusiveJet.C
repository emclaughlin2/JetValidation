...
#endif
void Fun4All_InclusiveJet(int nEvents = 100, int seg = 0, int isSim = 0, const char *filelistcalo = "dst_calo_cluster.list", const char *sim_type = "run15", const char *calo_type = "waveform")
{
  ...
  if (!isSim) {
    outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/output_" + to_string(runnumber) + "_" + to_string(segment) + ".root";
    //outfilename = "/sphenix/user/egm2153/calib_study/JetValidation/analysis/output_" + to_string(runnumber) + "_" + to_string(segment) + ".root";
  } else {
    if (!strcmp(sim_type,"run11_nopileup")) {
      outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_run11_nopileup_calo_cluster_output_" + to_string(seg) + ".root";
    } else if (!strcmp(sim_type,"detroit")) {
      if (!strcmp(calo_type,"cluster")) {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_detroit_calo_cluster_output_" + to_string(seg) + ".root";
      } else if (!strcmp(calo_type,"nozero")) {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_detroit_calo_nozero_output_" + to_string(seg) + ".root";
      } else {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_detroit_output_" + to_string(seg) + ".root";
      }
    } else if (!strcmp(sim_type,"detroit_jet10")) { 
      outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_detroit_jet10_output_" + to_string(seg) + ".root";
    } else {
      if (!strcmp(calo_type,"cluster")) {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_calo_cluster_output_" + to_string(seg) + ".root";
      } else if (!strcmp(calo_type,"nozero")) {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_calo_nozero_output_" + to_string(seg) + ".root";
      } else {
        outfilename = "/sphenix/tg/tg01/jets/egm2153/InclusiveJetOutput/sim_output_" + to_string(seg) + ".root";
      }
    }
  }
